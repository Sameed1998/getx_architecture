      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: Center(child: Text('something_went_wrong'.tr,textAlign: TextAlign.center,)),
          ),
          SizedBox(height: height * .15,),
          InkWell(
            ...
            child: Container(
              ...
              child: Center(child: Text('Retry'.tr,style: Theme.of(context).textTheme.titleMedium!.copyWith(color: AppColor.whiteColor,))),
            ),
          )
        ],
      ),
